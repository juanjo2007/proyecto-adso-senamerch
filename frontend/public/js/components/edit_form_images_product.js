...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const formImagesContainer = document.querySelector(".edit-form-images-product-container");

  // ================== FETCH DEL COMPONENTE ==================
  if (formImagesContainer) {
    fetch("/frontend/public/views/components/edit_form_images_product.html")
      .then(response => {
        if (!response.ok) throw new Error("Error al cargar edit_form_images_product.html");
  ...
  function initializeButtons() {
    ...
    if (submitBtn) {
      submitBtn.addEventListener("click", (e) => {
        ...
        showAlert("Producto editado exitosamente", "success");
